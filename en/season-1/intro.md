...
For zombies or cursed elites, you will need to have a certain resistance to the virus in order to damage them:

![elite damage](/assets/img/season-1/elite-damages.webp)

Since the virus resistance here (_9,500_) is lower than the required value (_10,100_), our attack will lose 12% of its
value.
...
{% include image.html url="/assets/img/season-1/new-building-resources.webp" description="Resources used and construction time for new buildings" %}
